...
- 002-traits-infrastructure: Added Bash (POSIX-compatible, uses `jq` for JSON), Markdown for commands/skills + `jq` (JSON parsing), `specify` CLI (spec-kit), `grep` (sentinel detection)
